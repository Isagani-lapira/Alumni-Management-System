    ...
    <div class="h-full p-5 relative">
        ...
        <div class="selectionStatus" style="height: 90%;">
            ...
            <div class="flex flex-col md:flex-row items-center justify-center gap-2 h-1/2">
                ...
                <div class="p-5 w-1/3 h-4/5 cursor-pointer bg-gray-300 center-shadow text-greyish_black hover:bg-accent hover:text-white rounded-lg flex items-center justify-center">
