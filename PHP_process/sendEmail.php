...
if (isset($_POST['message']) && isset($_POST['recipient']) && isset($_POST['subject'])) {
    ...
    if ($recipient == 'groupEmail') {
        ...
        if ($user != 'all') {
            ...
            $email = $emailInsertion->insertEmail($emailID, $user, $college, $date, $personID, $subject, trim($_POST['message']), $mysql_con);
        }
        //for all user
        else {
            ...
            $email = $emailInsertion->insertEmail($emailID, 'All', $college, $date, $personID, $subject, trim($_POST['message']), $mysql_con);
        }
    } else {
        ...
        if ($college != '') {
            ...
            $email = $emailInsertion->insertEmail($emailID, $recipient, $college, $date, $personID, $subject, trim($_POST['message']), $mysql_con);
        } else {
