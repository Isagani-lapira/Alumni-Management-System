    ...
    <div class="w-full h-screen flex justify-center items-center">
        <div class="h-max w-1/2 rounded-xl shadow-lg md:grid grid-cols-2 sm:block">
            <div class="bg-accent md:rounded-l-2xl text-white pt-10">
                <h2 class="text-xl text-center">We're Still Connected</h2>
            ...
            <div class="flex flex-col gap-2 p-3 items-center">
                ...
                <button id="univAdmin" value="univAdmin" onclick="redirect(this)" class="text-greyish_black font-medium py-2 px-2 bg-slate-300 shadow-lg rounded w-2/3 hover:bg-slate-400">
                    University Admin
                </button>
                <button id="colAdmin" value="colAdmin" onclick="redirect(this)" class="text-greyish_black font-medium py-2 px-2 bg-slate-300 shadow-lg rounded w-2/3 hover:bg-slate-400">
