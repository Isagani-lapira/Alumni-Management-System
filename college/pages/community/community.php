<section>
    ...
    <div id="community-tab" class="p-5">
        ...
        <!-- Post -->
        <div class="post p-3 w-4/6 mt-5 border shadow-lg">
        ...
        <div class="post p-3 w-4/6 mt-5 border shadow-lg">
            <div class="center-shadow p-3 rounded-md">
                <div class="flex justify-start items-center">
                    <div class="flex items-center">
                        <img class="h-12 border-2 border-accent rounded-full" src="https://scontent.fcrk1-5.fna.fbcdn.net/v/t39.30808-6/351103362_1066817541202762_7061615456230539997_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=09cbfe&_nc_eui2=AeHAxXMuXs3LZsB_UGHcCogWfrR9BgoGWtd-tH0GCgZa1_UaSpiyIxJI4al04F5AaOCjSprnd8AF06dRAx_MNy9F&_nc_ohc=sggZNHbUQSgAX-Wn9yK&_nc_ht=scontent.fcrk1-5.fna&oh=00_AfCMflGREHDCT9Syi76IebnP1rUKUc8NDrntnYpq30r1ug&oe=64851D4C" alt="">
                ...
                <img class="my-2 rounded-md" src="https://scontent.fcrk1-5.fna.fbcdn.net/v/t39.30808-6/344752985_769609177884860_8636565205679941281_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=8bfeb9&_nc_eui2=AeFRGVSr3QwheJN9qG8gtgfO1432UbccPWLXjfZRtxw9YiVsmQfUGcVNlgLaVpC6bdJEtxKcfPdFYWem2x0lJcjF&_nc_ohc=wMYLufpUWzQAX-Yz9J1&_nc_ht=scontent.fcrk1-5.fna&oh=00_AfBPl5vI8U4-prDTiOSyEeGYmHmuRYJdg6FgaTTmco-_RA&oe=648502D0" alt="">
                <div class="flex py-2 items-center">
                    <img class="h-5" src="/assets/icons/heart.png" alt="">
                    <span class="ms-2 text-sm">1,498</span>
                    <img class="ms-2 h-5" src="/assets/icons/comment.png" alt="">
